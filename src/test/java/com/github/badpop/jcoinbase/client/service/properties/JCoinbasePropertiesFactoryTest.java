...
class JCoinbasePropertiesFactoryTest {
  ...
  void should_not_return_thread_safe_singleton() {
    val computed = JCoinbasePropertiesFactory.buildWithoutThreadSafeSingleton("loremIpsum", "dolorSitAmet");
    val actual = JCoinbasePropertiesFactory.buildWithoutThreadSafeSingleton("loremIpsum", "dolorSitAmet");
  ...
  void should_return_new_instance_if_null() {
    val actual = JCoinbasePropertiesFactory.buildThreadSafeSingleton(null, null);
  ...
  void should_return_same_instance_if_already_computed() {
    val computed = JCoinbasePropertiesFactory.buildThreadSafeSingleton(null, null);
